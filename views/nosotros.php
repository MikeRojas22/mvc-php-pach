...
<body style="background-color:#4C0324;">
    ...
    <main class="main">
        <section class="group group--color">
            <div class="container">
                <h1 class="main__title">Nosotros</h1>
                <p class="main__subtitle">Filosofía</p>
                <p class="main__txt">Precios accesibles al mercado sin comprometer la calidad del producto, sin limite de creatividad.</p>
                    <a><center><img src="./../public/img/nosotros/ahorros.png" alt="" class="img_contenido"></center></a>
                <p class="main__subtitle">Misión</p>
                <p class="main__txt">Dedicada al diseño y elaboracion de productos artesanales de la mas alta calidad.</p>
                    <a><center><img src="./../public/img/nosotros/calidad.png" alt="" class="img_contenido"></center></a>
                <p class="main__subtitle">Visión</p>
                <p class="main__txt">Posicionarnos en el mercado mexicano como la empresa de confianza siendo marca lider a nivel nacional e internacional dando a conocer la riqueza artesanal de nuestro pais</p>
                    <a><center><img src="./../public/img/nosotros/lider.png" alt="" class="img_contenido"></center></a>
                <p class="main__subtitle">Valores</p>
                <p class="main__txt">Honestidad, calidad, orientación al cliente, compromiso, creatividad, integridad, pasion.</p>
                    <a><center><img src="./../public/img/nosotros/valores.png" alt="" class="img_contenido"></center></a>
            </div>
        </section>
    </main>
